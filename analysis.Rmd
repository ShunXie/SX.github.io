...
ggplot(tukey_result, aes(x = fct_reorder(contrast, estimate), y = estimate)) +
  geom_point() +
  geom_errorbar(aes(ymin = `conf.low`, ymax = `conf.high`)) +
  labs(title = "Contrast Estimates and 95% CI", ) + ylab("Estimate") + xlab("Contrast") + theme(axis.text.x = element_text(hjust = 1, angle = 45,size = 7))
